...
#if defined(WII_NATIVE_GX)
		(void)temp;
		/* GLimp_Init set glConfig.maxTextureSize to the GX limit; nothing to query */
#else
...
#if defined(WII_NATIVE_GX)
	r_tvborder = ri.Cvar_Get("r_tvborder", "0.04", CVAR_ARCHIVE);
	ri.Cvar_CheckRange(r_tvborder, 0, 0.15, qfalse);
#endif
