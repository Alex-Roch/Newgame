...
#ifdef WII_MAX_DRAWSURFS
#define	MAX_DRAWSURFS			WII_MAX_DRAWSURFS
#else
...
extern cvar_t	*r_tvborder;		// TV overscan safe-area inset, fraction of the screen
#include "../renderergx/tr_gx.h"
#endif
