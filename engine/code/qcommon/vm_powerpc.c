...
#ifdef GEKKO
#include <ogc/cache.h>  /* DCFlushRange, ICInvalidateRange; mmap shims come from wii_platform.h */
#else
#include <sys/mman.h>
#endif
#include <sys/time.h>
...
#ifdef GEKKO
	/* Broadway has split caches: push the generated code out of the data
	 * cache and drop any stale instruction-cache lines before it runs. */
