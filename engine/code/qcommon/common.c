...
#ifdef GEKKO
#define MIN_COMHUNKMEGS		WII_MIN_COMHUNKMEGS
#define DEF_COMHUNKMEGS 	WII_DEF_COMHUNKMEGS
#define DEF_COMZONEMEGS		WII_DEF_COMZONEMEGS
#define MIN_COMZONEMEGS		WII_MIN_COMZONEMEGS
#else
#define MIN_COMHUNKMEGS		56
#define DEF_COMHUNKMEGS 	384
#define DEF_COMZONEMEGS		64
#define MIN_COMZONEMEGS		DEF_COMZONEMEGS
#endif
...
#ifdef GEKKO
#define	MAX_CONSOLE_LINES	64	/* the Wii boot command line carries every +set */
#else
