...
#ifdef WII_PACKET_BACKUP
#define	PACKET_BACKUP	WII_PACKET_BACKUP	// Wii: half the snapshot history, see wii_platform.h
#else
...
#ifdef WII_MAX_SNAPSHOT_ENTITIES
#define	MAX_SNAPSHOT_ENTITIES	WII_MAX_SNAPSHOT_ENTITIES
#else
